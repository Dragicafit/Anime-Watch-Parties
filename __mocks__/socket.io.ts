...
> {
  ...
  constructor(
    ...
    super();
    this._serveClient = <any>null;
    this._path = <any>null;
    this.clientPathRegex = <any>null;
    this._connectTimeout = <any>null;
    this.httpServer = <any>null;
    if (
      "object" === typeof srv &&
...
const emitterMethods = Object.keys(EventEmitter.prototype).filter(function (
  ...
  return typeof (<any>EventEmitter.prototype)[key] === "function";
});

emitterMethods.forEach(function (fn) {
  (<any>Server.prototype)[fn] = function () {
    return (<any>this.sockets)[fn].apply(this.sockets, arguments);
  };
});
