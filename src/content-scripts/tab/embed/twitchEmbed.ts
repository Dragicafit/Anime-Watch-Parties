...
export class TwitchEmbed {
  ...
  startEmbed() {
    ...
    if (!$("#fullscreenTest").length) {
      ...
      >
        <div class="Box-body input-group mb-4">
          <input
            type="text"
            id="roomnumURL"
          ...
          <div class="input-group-button">
            <button
              id="copy"
              class="btn tooltipped tooltipped-no-delay tooltipped-n"
  ...
  update() {
    ...
    $("#roomnumURL").val(`https://awp.moe/${this.tabContext.tabRoom.roomnum}`);
    $("#roomnumURL").attr(
      "aria-label",
      `https://awp.moe/${this.tabContext.tabRoom.roomnum}`
    );
  }
